  ...
  return (
    <>
      <div className="relative pt-20 pb-32 flex content-center items-center justify-center min-h-screen bg-luxe-dark">
        ...
        {/* Hero Content */}
        <div className="container relative mx-auto px-4 z-10 pt-24">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 text-left">
              <motion.h1 
                ...
                className="text-white font-bold text-5xl md:text-7xl lg:text-8xl tracking-tight leading-none"
              >
                Beyond First <br />
                <span className="text-luxe-gold italic font-serif">Class</span>.
              </motion.h1>
              ...
              <motion.p 
                ...
                className="mt-8 text-xl md:text-2xl text-gray-300 max-w-xl font-light leading-relaxed"
              >
